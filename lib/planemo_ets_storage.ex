defmodule PlanemoEtsStorage do
  require Planemo
  ...
  defp insert_into_table([]), do: :undefined

  defp insert_into_table([{name, gravity, diameter, distance} | tail]) do
    :ets.insert(:planemos, Planemo.planemo(
      name: name,
      gravity: gravity,
      diameter: diameter,
